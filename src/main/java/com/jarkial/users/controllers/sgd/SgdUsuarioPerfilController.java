...
import com.jarkial.users.webservices.sgd.SgdUsuarioPerfilServiceWeb;

@RestController
@RequestMapping("/user/profiles")
public class SgdUsuarioPerfilController extends AbstractBaseController implements CrudController<SgdUsuarioPerfilModel, Long> {

    @Autowired
    SgdUsuarioPerfilServiceWeb serviceWeb;
    ...
    @Override
    @PostMapping("/new/")
    public ResponseEntity<?> create(@RequestBody @NotBlank @Valid SgdUsuarioPerfilModel model, HttpServletRequest request) throws Exception{
        ResponseEntity<?> response;
    ...
    public ResponseEntity<?> update(@PathVariable("id") Long entityId, @RequestBody @NotBlank @Valid SgdUsuarioPerfilModel model, HttpServletRequest request) throws Exception{
        ResponseEntity<?> response;
    ...
    public void InitBinderCreate(WebDataBinder binder) {
        binder.setDisallowedFields("sgdUsuarioPerfilId", "sgdPerfil", "sgdUsuario");
    }
